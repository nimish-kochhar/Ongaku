...
function MusicCard() {
    return (
        <div className="max-w-[250px] rounded-xl cursor-pointer ">
            <div className='overflow-hidden rounded-2xl relative group'>
                <img className="hover:scale-[1.2] hover:transition-all rounded-2xl object-cover h-full w-full" src={Image} alt="images lies here" />
            ...
            <div className="py-5">
                <h5 className="mb-2 text-xl font-bold leading-9 text-white">
                    ...
                    <span className="text-[#6e7273] ">Artist Name</span>
                </h5>
            </div>
        </div >
    )
